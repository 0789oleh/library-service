...
def test_member_unique_email(db_session: Session):
    ...
    with pytest.raises(IntegrityError):
        db_session.commit()
    db_session.rollback()  # Clean up session


def test_member_relationship(db_session: Session):
